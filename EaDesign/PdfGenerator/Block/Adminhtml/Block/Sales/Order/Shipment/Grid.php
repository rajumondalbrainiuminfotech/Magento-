 ...
 * @author eadesignpc
 */
class EaDesign_PdfGenerator_Block_Adminhtml_Block_Sales_Order_Shipment_Grid extends Mage_Adminhtml_Block_Sales_Shipment_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $templateCollection->addFieldToSelect('*')
            ->addFieldToFilter('pdft_type', EaDesign_PdfGenerator_Model_Pdfgenerator::SHIPPMENTTEMPLATE)
        ...
        $this->getMassactionBlock()->addItem('pdfsources_orderea', array(
            'label' => Mage::helper('sales')->__('EaDesgin PDF Shipments'),
