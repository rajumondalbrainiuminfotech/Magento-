 ...
 * @author eadesignpc
 */
class EaDesign_PdfGenerator_Block_Adminhtml_Block_Sales_Order_Creditmemo_Grid extends Mage_Adminhtml_Block_Sales_Creditmemo_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('pdfsources_orderea', array(
            'label' => Mage::helper('sales')->__('EaDesgin PDF Creditmemo'),
