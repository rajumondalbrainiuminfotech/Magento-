...
class EaDesign_PdfGenerator_Block_Adminhtml_Template_Pdf_New extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        $options = array(
            array('value' => EaDesign_PdfGenerator_Model_Pdfgenerator::ORDERTEMPLATE, 'label' => Mage::helper('adminhtml')->__('Order')),
            array('value' => EaDesign_PdfGenerator_Model_Pdfgenerator::INVOICETEMPLATE, 'label' => Mage::helper('adminhtml')->__('Invoice')),
            array('value' => EaDesign_PdfGenerator_Model_Pdfgenerator::CMEMOTEMPLATE, 'label' => Mage::helper('adminhtml')->__('Credit memo')),
            array('value' => EaDesign_PdfGenerator_Model_Pdfgenerator::SHIPPMENTTEMPLATE, 'label' => Mage::helper('adminhtml')->__('Shipping')),
            array('value' => EaDesign_PdfGenerator_Model_Pdfgenerator::PRODUCTTEMPLATE, 'label' => Mage::helper('adminhtml')->__('Product')),
        );
