...
class EaDesign_PdfGenerator_Helper_Variable extends Mage_Core_Helper_Abstract
{
    ...
    public function getItemSystemVariables()
    {
        ...
        $itemVariables[] = array(
            'label' => Mage::helper('pdfgenerator')->__('Qty Ordered(order only)'),
            'value' => '{{var ' . 'items_qty_ordered' . '}}'
        );
        $itemVariables[] = array(
            'label' => Mage::helper('pdfgenerator')->__('Qty Invoiced(order only)'),
            'value' => '{{var ' . 'items_qty_invoiced' . '}}'
        );
        $itemVariables[] = array(
            'label' => Mage::helper('pdfgenerator')->__('Qty Shipped(order only)'),
            'value' => '{{var ' . 'items_qty_shipped' . '}}'
        );
        $itemVariables[] = array(
            'label' => Mage::helper('pdfgenerator')->__('Qty Refunded(order only)'),
            'value' => '{{var ' . 'items_qty_refunded' . '}}'
        );
        $itemVariables[] = array(
            'label' => Mage::helper('pdfgenerator')->__('Qty Canceled(order only)'),
            'value' => '{{var ' . 'items_qty_canceled' . '}}'
        );
        $itemVariables[] = array(
        ...
        $itemVariables[] = array(
            'label' => Mage::helper('pdfgenerator')->__('Product list start'),
            'value' => '##productlist_start##'
        );

        $itemVariables[] = array(
            'label' => Mage::helper('pdfgenerator')->__('Product list end'),
            'value' => '##productlist_start##'
        );
    ...
    public function getInvoiceVariables()
    {
        $variables[] = array(
            ...
            'label' => Mage::helper('pdfgenerator')->__('Source Id'),
        );
        $variables[] = array(
            'value' => '{{var ea_invoice_status}}',
            'label' => Mage::helper('pdfgenerator')->__('Source Status'),
        );
        $variables[] = array(
            'value' => '{{var ea_invoice_date}}',
            'label' => Mage::helper('pdfgenerator')->__('Source Date'),
        );

        $variables = array(
            'label' => Mage::helper('pdfgenerator')->__('Source (Invoice, Creditmemo, Shippment)'),
            'value' => $variables
        );
        return $variables;
    }
    ...
    public function getTrackingVariables()
    {
        $variables[] = array(
            'value' => '{{var ea_shipmmnet_tracking}}',
            'label' => Mage::helper('pdfgenerator')->__('Tracking Datas'),
        );

        $variables = array(
            'label' => Mage::helper('pdfgenerator')->__(' Shippment Tracking'),
            'value' => $variables
        );
        return $variables;
    }
    ...
    public function getProductStandardVariables()
    {
        $variables[] = array(
        ...
        $variables[] = array(
            'value' => '{{var productimageview}}',
            'label' => Mage::helper('sales')->__('Product Image'),
        );
        $variables[] = array(
            'value' => '{{var productviewattributes}}',
            'label' => Mage::helper('sales')->__('Product View Attributes'),
        );
        $variables[] = array(
            'value' => '{{var productdescription}}',
            'label' => Mage::helper('sales')->__('Product description'),
        );
        $variables[] = array(
            'value' => '{{var productshortdescription}}',
            'label' => Mage::helper('sales')->__('Product short description'),
        );
        $variables[] = array(
            'value' => '{{var productweight}}',
            'label' => Mage::helper('sales')->__('Product weight'),
        );
        $variables[] = array(
            'value' => '{{var producturl}}',
            'label' => Mage::helper('sales')->__('Product url path'),
        );
        $variables[] = array(
            'value' => '{{var productsku}}',
            'label' => Mage::helper('sales')->__('Product SKU'),
        );
        ...
        $variables = array(
            'label' => Mage::helper('pdfgenerator')->__('Product Standard'),
            'value' => $variables
        );
        return $variables;
    }

    public function getProductTemplateVariables()
    {
        $variables[] = array(
            'value' => '{PAGENO}',
            'label' => Mage::helper('sales')->__('Page Number (Header/Footer)')
        ...
        $variables = array(
            'label' => Mage::helper('pdfgenerator')->__('Template variables'),
            'value' => $variables
        );
        return $variables;
    }
